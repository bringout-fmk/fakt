...
/*! \file fmk/fakt/ugov/1g/p_ugov.prg
 *  \brief printanje i ispravka ugovora
 */


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_A1
  * \brief Koristi li se polje A1 iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_A1;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_A2
  * \brief Koristi li se polje A2 iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_A2;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_B1
  * \brief Koristi li se polje B1 iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_B1;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_B2
  * \brief Koristi li se polje B2 iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_B2;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_DINDEM
  * \brief Koristi li se polje DINDEM iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_DINDEM;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_Datumi
  * \brief Koriste li se polja DATOD i DATDO iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_Datumi;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_K1
  * \brief Koristi li se polje K1 iz baze definicije stavki ugovora RUGOV ?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_K1;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_K2
  * \brief Koristi li se polje K2 iz baze definicije stavki ugovora RUGOV ?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_K2;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_Opis
  * \brief Koristi li se polje opisa NAZ iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_Opis;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_Rabat_Porez
  * \brief Koriste li se polja RABAT i POREZ iz baze definicije stavki ugovora RUGOV ?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_Rabat_Porez;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_TXT
  * \brief Koristi li se polje IDTXT iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_TXT;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_TXT2
  * \brief Koristi li se polje IDDODTXT iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_TXT2;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_Tip
  * \brief Koristi li se polje IDTIPDOK iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_Tip;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_Trznica
  * \brief Koriste li se specificnosti radjene za Trznicu ?
  * \param N - ne, default vrijednost
  * \param D - da
  */
*string FmkIni_ExePath_Fakt_Ugovori_Trznica;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_Vrsta
  * \brief Koristi li se polje VRSTA iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_Vrsta;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_Zaokruzenja
  * \brief Koristi li se polje ZAOKR iz sifrarnika ugovora?
  * \param D - da, default vrijednost
  * \param N - ne
  */
*string FmkIni_ExePath_Fakt_Ugovori_Zaokruzenja;


/*! \ingroup ini
  * \var *string FmkIni_ExePath_Fakt_Ugovori_ZakupljeniArtikli
  * \brief Uslov za obuhvatanje grupe artikala po sifri (u Trznici su ti artikli ustvari prostori pod zakupom). Koristi se za pregled ugovora koji se odnose na te "artikle"
  * \param K--T; - default vrijednost
  */
*string FmkIni_ExePath_Fakt_Ugovori_ZakupljeniArtikli;

 
/*! \fn P_Ugov(cId,dx,dy)
 *  \brief Ispravka ugovora
 *  \param cId
 *  \param dx
 *  \param dy
 */
...
IF IzFMkIni('Fakt_Ugovori',"Trznica",'N')=="D"
  return PostojiSifra(F_UGOV,"NAZ2", 10, 77, ;
         "Lista Ugovora <F5> - definisi ugovorÍÍÍÍ<F6> - izvjestaj/lista za K1='G'", ;
...
elseif Ch==K_F2 .or. Ch==K_CTRL_N
 ...
 ENDIF
   ...
   if IzFMkIni('Fakt_Ugovori',"Datumi",'D')=="D"
       ...
       if IzFMkIni('Fakt_Ugovori',"DINDEM",'D')=="D"
          @ m_x+10,m_y+2 SAY "Valuta (" + gOznVal + "/DEM)   " GET _dindem PICT "@!"
       endif
...
/*! \fn P_Destin(cId,dx,dy)
 *  \brief Otvara sifradnik destinacija
 *  \param cId
 *  \param dx
 *  \param dy
 */
...
// ObjDbedit("",10,70,{|Ch| EdDestBlok(Ch)},"","Destinacije za:"+cIdTek+"-"+Ocitaj(F_PARTN,cIdTek,"naz"), , , , ,,)
...
/*! \fn EdDestBlok(Ch,cDest)
 *  \brief Obrada funkcija nad sifranikom destinacija
 *  \param Ch
 *  \param cDest
 */
...
do case
  case Ch==K_F2  .or. Ch==K_CTRL_N
     ...
     Box(, 11,75,.f.)
//       @ m_x+1,m_y+2 SAY "ID partnera       " GET sID       PICT "@!"
...
/*! \fn P_Ugov2(cIdPartner)
 *  \brief
 *  \param cIdPartner - prosljedjeni partner iz sif partnera
 */
...
PRIVATE gTBDir:="D"
ImeKol:={}; Kol:={}
AADD(ImeKol,{ "IDRoba",   {|| IdRoba}  , "IDROBA"  , {|| .t.}, {|| glDistrib.and.RIGHT(TRIM(widroba),1)==";".or.JImaRoba(@widroba)}, ">" })
...
/*! \fn EdUgov2()
 *  \brief Obrada funkcija nad sifrarnikom ugovora
 */
 
function EdUgov2()
*{
local nRet:=-77, nRec:=RECNO(), nArr:=SELECT()
local GetList:={}
...
do case
  ...
  case Ch==K_CTRL_N
    ...
    _id := cIdUg
    Box(,8,77)
     @ m_x+2, m_y+2 SAY "SIFRA ARTIKLA:" GET _idroba VALID glDistrib.and.RIGHT(TRIM(_idroba),1)==";".or.JImaRoba(@_idroba) PICT "@!"
...
/*! \fn OsvjeziPrikUg(lWhen,lNew)
 *  \brief Osvjezava prikaz ugovora
 *  \param lWhen
 *  \param lNew
 */
...
LOCAL GetList:={}
  ...
  IF !lIni
    Box(,10,75)
     ...
     @ m_X+ 6,m_y+ 2 SAY "Valuta (" + gOznVal + "/DEM)" GET DFTdindem   PICT "@!"
...
/*! \fn MSay2(x,y,c)
 *  \brief Prikaze neki tekst c na lokaciji x,y
...
function JImaRoba(cIdRoba)
*{
local lRet
local cPrevTBDir:=gTBDir
gTBDir:="N"
lRet:=P_Roba(@cIdRoba)
gTBDir:=cPrevTBDir
return lRet
